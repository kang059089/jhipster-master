...
describe('Service Tests', () => {
    describe('VersionFile Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(VersionFileService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/version-files';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a VersionFile', () => {
                service.create(new VersionFile(null)).subscribe(received => {
            ...
            it('should update a VersionFile', () => {
                service.update(new VersionFile(123)).subscribe(received => {
            ...
            it('should return a VersionFile', () => {
